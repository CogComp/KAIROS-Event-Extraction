...
#         PoS Tagging
# ============================
pos_tags = ["ADJ", "ADP", "ADV", "AUX", "CONJ", "CCONJ", "DET", "INTJ", "NOUN", "NUM", "PART", "PRON", "PROPN", "PUNCT",
...
#       KAIROS Reader
# =========================
def ltf_reader(dir_name, file_name, spaCy=False):
    my_dict = {}
        ...
        for TEXT in child:
            for SEG in TEXT:
                ...
                if spaCy == True:
                    ...
                    sent_dict["token_span_DOC"] = span_SENT_to_DOC(sent_dict["token_span_SENT"],
                                                                   sent_dict["sent_start_char"])
                else:
                    ...
                    for TOKEN in SEG:
                        if temp_count > 0:  # Not including SEG[0]
                            sent_dict["token_span_DOC"].append(
                                [int(TOKEN.attrib["start_char"]), int(TOKEN.attrib["end_char"])])
